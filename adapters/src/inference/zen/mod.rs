...
const CONFIGURATION_ENDPOINT: &str = "inference.providers.zen.endpoint";
const CONFIGURATION_APIKEY: &str = "inference.providers.zen.apikey";
...
#[async_trait]
impl InferenceProvider for Zen {
    async fn infer(
        &self,
        ctx: &AppContext,
        options: &Options,
